...
* [Pryaxis/TShock](https://github.com/Pryaxis/TShock) - A server mod for Terraria that adds features everyone loves. [https://tshock.co/](https://tshock.co/)
...
* [Pryaxis/TerrariaAPI-Server](https://github.com/Pryaxis/TerrariaAPI-Server) - The Terraria server API of the future. [http://tshock.co/](http://tshock.co/)
...
* [electron/electron](https://github.com/electron/electron) - Build cross platform desktop apps with JavaScript, HTML, and CSS [https://electron.atom.io](https://electron.atom.io)
...
* [ryanoasis/nerd-fonts](https://github.com/ryanoasis/nerd-fonts) - :abcd: Iconic font aggregator, collection, and patcher: 34 patched fonts (77k+ variations). Includes popular glyph collections such as Font Awesome & fonts such as Hack [https://NerdFonts.com](https://NerdFonts.com)
...
* [tumashu/ox-latex-chinese](https://github.com/tumashu/ox-latex-chinese) - Obsoleted project, please use org2ctex instead []()
...
* [FGRibreau/mailchecker](https://github.com/FGRibreau/mailchecker) - :mailbox: Cross-language temporary (disposable/throwaway) email detection library. Covers 3030 fake email providers. [http://twitter.com/FGRibreau](http://twitter.com/FGRibreau)
...
* [vintasoftware/python-api-checklist](https://github.com/vintasoftware/python-api-checklist) - Useful checklist for build good Python libraries APIs, based on "How to make a good library API" PyCon 2017 talk: https://www.youtube.com/watch?v=4mkFfce46zE [http://python.apichecklist.com](http://python.apichecklist.com)
...
* [Blankj/AndroidUtilCode](https://github.com/Blankj/AndroidUtilCode) - :fire: Android developers should collect the following utils(updating) [http://blankj.com/AndroidUtilCode](http://blankj.com/AndroidUtilCode)
...
* [INRIA/spoon](https://github.com/INRIA/spoon) - Spoon is a library to analyze, transform, rewrite, transpile Java source code (incl Java 8). It parses source files to build a well-designed AST with powerful analysis and transformation API. Made at Inria with :heart:, :beers: and :sparkles:. [http://spoon.gforge.inria.fr/](http://spoon.gforge.inria.fr/)
...
* [howdyai/botkit](https://github.com/howdyai/botkit) - Botkit is a toolkit for making bot applications [http://botkit.ai](http://botkit.ai)
...
* [disoul/electron-cloud-music](https://github.com/disoul/electron-cloud-music) - 网易云音乐 Electron  客户端(等待填坑) []()
...
* [colebemis/feather](https://github.com/colebemis/feather) - Simply beautiful open source icons [https://feathericons.com](https://feathericons.com)
...
* [EmergingTechnologyAdvisors/node-serialport](https://github.com/EmergingTechnologyAdvisors/node-serialport) - Node.js package to access serial ports. Linux, OSX and Windows. Welcome your robotic JavaScript overlords. Better yet, program them! []()
...
* [Unitech/pm2](https://github.com/Unitech/pm2) - Production Process Manager for Node.js apps with a built-in Load Balancer. [http://pm2.io/](http://pm2.io/)
...
* [prettier/prettier](https://github.com/prettier/prettier) - Prettier is an opinionated code formatter. [https://prettier.io/playground/](https://prettier.io/playground/)
* [GoogleChrome/proxy-polyfill](https://github.com/GoogleChrome/proxy-polyfill) - Proxy object polyfill []()
* [GoogleChrome/puppeteer](https://github.com/GoogleChrome/puppeteer) - Headless Chrome Node API [https://try-puppeteer.appspot.com/](https://try-puppeteer.appspot.com/)
...
* [theos/theos](https://github.com/theos/theos) - A cross-platform suite of tools for building and deploying software for iOS and other platforms. [https://github.com/theos/theos/wiki](https://github.com/theos/theos/wiki)
...
* [adobe-fonts/source-han-sans](https://github.com/adobe-fonts/source-han-sans) - Source Han Sans | 思源黑体 | 思源黑體 | 源ノ角ゴシック | 본고딕 [http://adobe.ly/SourceHanSans](http://adobe.ly/SourceHanSans)
...
* [Trinea/android-open-project](https://github.com/Trinea/android-open-project) - A categorized collection of Android Open Source Projects,  Dev Tools Pro: [https://play.google.com/store/apps/details?id=cn.trinea.android.developertools.pro](https://play.google.com/store/apps/details?id=cn.trinea.android.developertools.pro)
...
* [Homebrew/legacy-brew-evolution](https://github.com/Homebrew/legacy-brew-evolution) - :skull: Homebrew/brew-evolution (deprecated) []()
...
* [twitter/reasonable-scala](https://github.com/twitter/reasonable-scala) - An experimental Scala compiler focused on compilation speed []()
...
* [maxking/docker-mailman](https://github.com/maxking/docker-mailman) - Dockerfiles for the mailman suite. [http://asynchronous.in/docker-mailman/](http://asynchronous.in/docker-mailman/)
...
* [dirkschumacher/llr](https://github.com/dirkschumacher/llr) - Lisp-like-R []()
...
* [Homebrew/legacy-homebrew](https://github.com/Homebrew/legacy-homebrew) - :skull: The former home of Homebrew []()
...
* [apache/incubator-predictionio](https://github.com/apache/incubator-predictionio) - PredictionIO, a machine learning server for developers and ML engineers. Built on Apache Spark, HBase and Spray. [https://predictionio.incubator.apache.org](https://predictionio.incubator.apache.org)
...
* [neovim/node-host](https://github.com/neovim/node-host) - Remote node.js host for neovim (will soon be included in neovim) []()
