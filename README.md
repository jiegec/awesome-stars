...
* [leachim6/hello-world](https://github.com/leachim6/hello-world) - Hello world in every programming language.  Thanks to everyone who contributes to this, I read all pull requests! [http://github.com/leachim6/hello-world/wikis](http://github.com/leachim6/hello-world/wikis)
...
* [xtaci/libkcp](https://github.com/xtaci/libkcp) - kcp client session library for iOS/Android []()
...
* [tekezo/Karabiner-Elements](https://github.com/tekezo/Karabiner-Elements) - The next generation Karabiner prototyping for macOS Sierra [https://pqrs.org/osx/karabiner/](https://pqrs.org/osx/karabiner/)
...
* [FGRibreau/mailchecker](https://github.com/FGRibreau/mailchecker) - :mailbox: Cross-language temporary (disposable/throwaway) email detection library. Covers 2732 fake email providers. [http://twitter.com/FGRibreau](http://twitter.com/FGRibreau)
...
* [Wilfred/elisp-refs.el](https://github.com/Wilfred/elisp-refs.el) - semantic code search for emacs lisp []()
...
* [appleshan/emacs-counsel-sift](https://github.com/appleshan/emacs-counsel-sift) - allows you to search using sift from inside Emacs. []()
...
* [xtaci/kcp-go](https://github.com/xtaci/kcp-go) - A full-featured reliable UDP communication library for golang []()
...
* [Peaker/resolve-trivial-conflicts](https://github.com/Peaker/resolve-trivial-conflicts) - Resolve trivial conflicts []()
...
* [Blankj/AndroidUtilCode](https://github.com/Blankj/AndroidUtilCode) - Android developers should collect the following utils(updating) [http://blankj.com/862.html](http://blankj.com/862.html)
...
* [caoqianli/apk-parser](https://github.com/caoqianli/apk-parser) - Apk parser lib for java []()
...
* [INRIA/spoon](https://github.com/INRIA/spoon) - Spoon is a library for analyzing, rewriting, transforming, transpiling Java source code. It parses source files to build a well-designed AST with powerful analysis and transformation API. It fully supports Java 8.  :beers: :sparkles: [http://spoon.gforge.inria.fr/](http://spoon.gforge.inria.fr/)
...
* [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) - 微信小程序开发资源汇总 wechat weapp []()
...
* [eosrei/emojione-color-font](https://github.com/eosrei/emojione-color-font) - ⚛A color emoji SVGinOT font using EmojiOne Unicode 9.0 emoji with diversity and country flags. Linux/MacOS/Windows []()
...
* [eosrei/twemoji-color-font](https://github.com/eosrei/twemoji-color-font) - ⛱A color emoji SVGinOT font using Twitter Unicode 9.0 emoji with diversity and country flags. Linux/MacOS/Windows []()
...
* [Homebrew/brew-evolution](https://github.com/Homebrew/brew-evolution) - :fast_forward: Proposals for changes to the Homebrew package manager. []()
...
* [Kahaani/dieghv](https://github.com/Kahaani/dieghv) - 潮语拼音输入法 - Rime schema for Teochew dialect - http://kahaani.github.io/dieghv []()
...
* [osfans/PIME](https://github.com/osfans/PIME) - Develop input methods for Windows easily with Python []()
...
* [jkbrzt/httpie](https://github.com/jkbrzt/httpie) - Command line HTTP client, a user-friendly curl alternative with an intuitive UI, JSON support, syntax highlighting, wget-like downloads, extensions, etc. Follow https://twitter.com/clihttp for tips and updates. [https://httpie.org](https://httpie.org)
...
* [platformio/platformio](https://github.com/platformio/platformio) - An open source ecosystem for IoT development :alien: Cross-platform build system and library manager. Continuous and IDE integration. Arduino, ESP8266 and ARM mbed compatible. [http://platformio.org](http://platformio.org)
...
* [Homebrew/brew](https://github.com/Homebrew/brew) - :beer: The missing package manager for macOS [http://brew.sh](http://brew.sh)
...
* [heroku/heroku](https://github.com/heroku/heroku) - Heroku CLI [https://cli.heroku.com](https://cli.heroku.com)
...
* [dylanaraps/neofetch](https://github.com/dylanaraps/neofetch) - A fast, highly customizable system info script that supports Linux, OS X, iOS, BSD, Solaris and Windows (Cygwin) []()
...
* [xiaoxinghu/CocoaOrg](https://github.com/xiaoxinghu/CocoaOrg) - org-mode with swift []()
...
* [bhurlow/vim-parinfer](https://github.com/bhurlow/vim-parinfer) - rpc style parinfer plugin for vim []()
